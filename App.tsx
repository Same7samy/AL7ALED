...
import CheckoutPage from './pages/CreditSalePage';
import CustomerDetailPage from './pages/CustomerDetailPage';
import InvoiceDetailPage from './pages/InvoiceDetailPage';
import { AppData, AppSettings, Page, Product, CustomFieldDef, Notification, CartItem, Customer, Supplier, Invoice, Payment, PurchaseInvoice, PurchaseInvoiceItem, SupplierPayment, Expense, Offer, Coupon, Toast } from './types';
